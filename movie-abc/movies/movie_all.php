...
<head>
	...
	<body>
                ...
                function seeMovies(auto_mov_id){
                    window.location.href = "movie_page.php?mov_id="+auto_mov_id;
                }
...
//                    alert(search_movie);
                    window.location.href = "movie_all.php?search="+search_movie;
                                        ...
                                        <?php
                                        $count_all_movies  = " SELECT COUNT(*) AS mov_amt FROM mov_details WHERE kind = 'MOV' ";
				...
				<hr/>
					...
					<div class="col-lg-9">
						<div class="row">
                                    ...
                                    $sql_this_yr = "SELECT * FROM mov_details WHERE 1=1 $where AND kind = 'MOV' limit $page_sql,$perpage ";
//                                    echo $sql_this_yr;
